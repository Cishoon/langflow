...
import CustomLogo from "@/assets/CustomLogo.svg?react";
...
export default function AppHeader(): JSX.Element {
  ...
  return (
    <div
      className={`z-10 flex h-[48px] w-full items-center justify-between border-b pr-5 pl-5 dark:bg-background`}
